...
public partial class ViewTransactionTransactionStatusJoin
{
    ...
    public string TransactionStatusCreatedBy { get; set; } = null!;
    ...
    public string TransactionStatusUpdatedBy { get; set; } = null!;
